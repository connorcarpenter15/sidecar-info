...
| [`kvbm_support.md`](./kvbm_support.md) | KVBM status (agg tiering + KV-aware routing + disagg P/D all work; remote/G4 deferred) and the engine-side config the sidecar topology requires. |
